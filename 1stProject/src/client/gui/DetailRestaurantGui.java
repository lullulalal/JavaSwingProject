...
public class DetailRestaurantGui extends JDialog{
	...
	public void addPanel(Restaurant r, Member from){
		...
		JLabel lbl_type_t = new JLabel("À½½ÄÁ¾·ù   :  " + Category.getStringFoodType(
				r.getCategory().getType()));
		lbl_type_t.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 14));
		p_evaluate_in.add(lbl_type_t);
		lbl_type_t.setPreferredSize(new Dimension(110, 15));
		
		JLabel lbl_taste_t = new JLabel("¸À ");
		lbl_taste_t.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 14));
		...
		lbl_taste.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.BOLD, 14));
		p_evaluate_in.add(lbl_taste);
		
		JLabel lbl_service_t = new JLabel("¼­ºñ½º ");
		lbl_service_t.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 14));
		...
		lbl_service.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.BOLD, 14));
		p_evaluate_in.add(lbl_service);
		
		JLabel lbl_hygiene_t = new JLabel("Ã»°áµµ ");
		lbl_hygiene_t.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 14));
		...
		lbl_hygiene.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.BOLD, 14));
		p_evaluate_in.add(lbl_hygiene);
		
		JLabel lbl_average_t = new JLabel("Æò ±Õ");
		lbl_average_t.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 14));
		...
		lbl_average.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.BOLD, 14));
		...
		ta_comment_in.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 12));
		...
		if(r.getMenu().size() >= 3){
			...
			lbl_menu3_i.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 14));
		...
		if(r.getMenu().size() >= 4){
			...
			lbl_menu4_i.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 14));
		...
		JLabel lbl_detail = new JLabel("»ó¼¼ Á¤º¸");
		p_restaurant.add(lbl_detail);
		lbl_detail.setPreferredSize(new Dimension(170, 25));
		lbl_detail.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 16));
	
		
		JLabel lbl_address_t = new JLabel("ÁÖ¼Ò");
		p_restaurant.add(lbl_address_t);
		lbl_address_t.setPreferredSize(new Dimension(175, 25));
		lbl_address_t.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 16));
		...
		ta_address_in.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 12));
		...
		if(from != null){
			//test 
			JLabel re = new JLabel("ÀÌ ¸ÀÁýÀ»  " + "\"" + from.getId()+ "\"" +" ´Ô¿¡°Ô ");
			re.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 17));
			...
			if(LoginStatement.getLoginUser() != null){
				if(LoginStatement.getLoginUser().getPermission()
					...
					JLabel re = new JLabel("´ñ±ÛÀ» ³²°Ü ÁÖ¼¼¿ä~!");
					re.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 17));
					...
					lb_btn.addMouseListener(new MouseAdapter(){
						...
						== Member.VALUER){
					JLabel re = new JLabel("¸ÀÁýÀ¸·Î ÃßÃµ ÇÏ±â~!");
					re.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 17));
		...
		JLabel lbl_userevaluate = new JLabel("À¯Àú ÇÑ ÁÙ Æò°¡");
		p_restaurant.add(lbl_userevaluate);
		lbl_userevaluate.setPreferredSize(new Dimension(360, 25));
		lbl_userevaluate.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 16));
		...
		for(Evaluation e : userElist){
			...
			lbl_userid_i.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 12));
			...
			lbl_usercomment_i.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 12));
			...
			lbl_userevaluate_i.setFont(new Font("³ª´®¹Ù¸¥°íµñ", Font.PLAIN, 12));
			...
			while(true) {
				try {
					...
					case "evaluate":
						...
						if(evaluateRst == true){
							JOptionPane.showMessageDialog(DetailRestaurantGui.getDetailRIfoDlg(), "µî·Ï ¼º°ø~");
							...
							JOptionPane.showMessageDialog(DetailRestaurantGui.getDetailRIfoDlg(), "ÇÑ¹ø¸¸ µî·Ï °¡´É ÇÕ´Ï´Ù~!");
						}
					...
					case "recommend":
						...
						if(recommendRst == true){
							JOptionPane.showMessageDialog(DetailRestaurantGui.getDetailRIfoDlg(), "ÃßÃµ Çß½À´Ï´Ù~!");
							tabbedPane.remove(pRecentely);
							Restaurant r = (Restaurant)receive[3];
							...
							JOptionPane.showMessageDialog(DetailRestaurantGui.getDetailRIfoDlg(), "ÇÑ¹ø¸¸ ÃßÃµ °¡´É ÇÕ´Ï´Ù~!");
						}
						break;
